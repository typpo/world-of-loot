...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.slot'
        db.alter_column('main_item', 'slot', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'Item.icon'
        db.alter_column('main_item', 'icon', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

    def backwards(self, orm):

        # Changing field 'Item.slot'
        db.alter_column('main_item', 'slot', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Item.icon'
        db.alter_column('main_item', 'icon', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
